export class SliderView {
  ...
  create() {
    ...
    this.slider = slider;
    this.options.elem.after(this.slider);
    this.isCreated = true;
  }
  ...
  createControls() {
    return `
      <div class="slider-controls">
        <button class="slider-up-btn slider-btn" data-action="moveUp">
          &#129045;
        </button>
        <button class="slider-down-btn slider-btn" data-action="moveDown">
         &#129047;
       </button>
      </div>`;
  }
